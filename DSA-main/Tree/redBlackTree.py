...
class RedBlackTree:
    ...
    def delete(self, value):
        ...
        if node_to_remove.left is None or node_to_remove.right is None:
            self._replace_node(node_to_remove, node_to_remove or node_to_remove.right)
        else:
...
if __name__ == "__main__":
    ...
    tree.insert(50)
    tree.insert(25)
    print(f'In-order traversal of Red Black Tree')
    tree._inorder_traversal(tree.root)
    print()
    tree.delete(20)
    print(f'In-order traversal of Red Black Tree after deleting 20')
    tree._inorder_traversal(tree.root)
    print()
